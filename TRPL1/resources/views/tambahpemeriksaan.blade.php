...
<body style="background-color:#cfd8dc;">
	...
	<div class="container">
		<div class="row">
			<form class="col s11 offset-s2" method="POST" action="{{ url('/add/pemeriksaans') }}">
				...
				<div class="row">
					<div class="input-field col s3">
						<select name="id_pendaftaran">
							<option value="" disabled selected>Pilih Id Pendafataran</option>
				...
				<div class="row">
					<div class="input-field col s10">
						<input id="icon_telephone" type="tel" class="validate" name="diagnosa_penyakit">
