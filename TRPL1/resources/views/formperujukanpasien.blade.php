	...
	<div class="container">
		<div class="row">
			<form class="col s11 offset-s2" method="POST" action="{{ url('/add/rujukans') }}">
				...
				<div class="row">
					<div class="input-field col s10">
						<select name="id_pelayanan">
							<option value="" disabled selected>Pilih Id Pelayanan</option>
				...
				<div class="row">
					<div class="input-field col s10">
						<input id="icon_telephone" type="tel" class="validate" name="keterangan">
						<label for="Alamat">keterangan</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s10">
						<input id="icon_telephone" type="tel" class="validate" name="tempat_rujukan">
